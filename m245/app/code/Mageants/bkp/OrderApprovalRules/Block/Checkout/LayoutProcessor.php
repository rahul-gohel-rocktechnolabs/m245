 ...
 */
namespace Mageants\OrderApprovalRules\Block\Checkout;
...
/**
 * Class LayoutProcessor used for get the attribute and set the attributes
 */
class LayoutProcessor implements \Magento\Checkout\Block\Checkout\LayoutProcessorInterface
{
    ...
    private function processPaymentConfiguration(array &$configuration, array $elements)
    {
        ...
        $isApproval = $this->OrderApprovalRules->getComputedValues();
        foreach ($configuration as $paymentGroup => $groupConfig) {
            if ($isApproval) {
                if ($paymentGroup == 'order-approval') {
                ...
                unset($configuration['order-approval']);
            }
        }
        return $output;
    }
