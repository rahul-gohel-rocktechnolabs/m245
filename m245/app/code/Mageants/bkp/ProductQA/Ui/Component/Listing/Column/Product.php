...
class Product extends \Magento\Ui\Component\Listing\Columns\Column
{
     ...
     */
    public const  URL_PATH_PRODUCT_EDIT = "catalog/product/edit/";
    /**
     * @var UrlInterface
     */
   ...
   */
    ...
    public function prepareDataSource(array $dataSource)
    {
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            $productCollection->addFieldToSelect(['name','entity_id'])
            ->addFieldToFilter('entity_id', ['in' =>array_unique($prduct_ids)]);
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                onclick='setLocation(\"{$prod_url}\")'>".$prducts[$item['product_id']]."</a>";
            }
        }
        return $dataSource;
    }
