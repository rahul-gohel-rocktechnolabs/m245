...
use Mageants\Orderattribute\Api\Data;
use Magento\Framework\Exception\CouldNotDeleteException;
use Magento\Framework\Exception\CouldNotSaveException;
use Magento\Framework\Exception\NoSuchEntityException;
use Magento\Framework\Exception\ValidatorException;

class RelationRepository implements \Mageants\Orderattribute\Api\RelationRepositoryInterface
{
    /**
    ...
    public function __construct(
        \Mageants\Orderattribute\Model\ResourceModel\Relation $relationResource,
    ...
    public function get($relationId)
    {
        if (!isset($this->relations[$relationId])) {
            /** @var \Mageants\Orderattribute\Model\Relation $relation */
