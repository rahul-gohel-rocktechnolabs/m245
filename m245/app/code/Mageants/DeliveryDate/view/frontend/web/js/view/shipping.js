    ...
    return Component.extend({
                    ...
                    function () {
                        setInterval(function () {
                                ...
                                if(pageURL.indexOf("payment") != -1){
                                    $("#payment-delivery").show();
                                } else {
                                    $("#payment-delivery").hide();
                                }
                        },1000);
                        
                        $("#payment-delivery #date").text(quote.extension_attributes.delivery_date);
                        $("#payment-delivery #timeslot").text(quote.extension_attributes.delivery_timeslot);
                        $("#payment-delivery #comment").text(quote.extension_attributes.delivery_comment);
        ...
        validateShippingInformation: function () {
            ...
            if (!quote.shippingMethod()) {
             ...
             //if(!$("#delivery_date").closest(".checkout-payment-method").is(":hidden"))
            if(!$("#delivery_date").closest(".checkout-payment-method").is(":hidden"))
            {
